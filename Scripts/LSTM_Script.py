# -*- coding: utf-8 -*-
"""LSTM WikiText2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1upNX8Ok8K2njZ9H3FeUTVcRW3AMHBRJv
"""
...
run([sys.executable, "-m", "pip", "install", "-q", "stanza"], check=True)
import stanza
...
def split_data(data, num_sentences=-1):
    if(tokenizer == Tokenizer.NLTK):
        sentences = sent_tokenize(data) if num_sentences == -1 else sent_tokenize(data)[:num_sentences]
    elif (tokenizer == Tokenizer.STANZA):
        sentences = split_sentences(data, nlp) if num_sentences == -1 else split_sentences(data, nlp)[:num_sentences]
